...
public class Message implements Comparable<Message> {
	...
	return new StringBuilder().append(severity.label + " -").append(line != 0 ? ("line:" + line + " ") : " ")
		.append(col != 0 ? ("column:" + col + " ") : " ").append(message + " ")
		.append(cause != null ? cause.getMessage() : "").toString();
    }

    @Override
    public int compareTo(Message msg) {
	// compare by severity then line and finally by column
	return Integer.compare(severity.priority, msg.severity.priority) != 0
		? Integer.compare(severity.priority, msg.severity.priority)
