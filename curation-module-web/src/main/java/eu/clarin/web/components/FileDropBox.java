...
public class FileDropBox extends DragAndDropWrapper implements DropHandler{
    ...
    private static final Logger _logger = LoggerFactory.getLogger(FileDropBox.class);
        ...
        if (files != null) {
            for (final Html5File html5File : files) {
                ...
                if (html5File.getFileSize() > FILE_SIZE_LIMIT) {
                    Notification.show("File rejected. Max 10Mb files are accepted by Sampler",
                	...
                	try {
						...
						_logger.error("Error while uploading file: "+e.getMessage());
					}
                }
            }
