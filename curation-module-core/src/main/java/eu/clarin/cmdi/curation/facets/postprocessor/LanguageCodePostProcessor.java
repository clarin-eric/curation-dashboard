...
public class LanguageCodePostProcessor extends PostProcessorsWithControlledVocabulary{
	...
	public String getVocabularyName() {
    	return VLOConfigFactory.getVloConfig().getLanguageNameVariantsUrl();
	}
    ...
    protected String extractLanguageCode(String value) {
        ...
        // map known language name variants to their official name
