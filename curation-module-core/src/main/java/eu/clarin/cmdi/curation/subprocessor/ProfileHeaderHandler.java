...
//			report.header.setUrl(schemaLocation.startsWith("file:")?"n.a.":Configuration.BASE_URL+"rest/profile/"+report.getName()+".xml");
		...
		report.url = Configuration.BASE_URL + "rest/profile/" + FileNameEncoder.encode(report.getName()) + ".xml";
