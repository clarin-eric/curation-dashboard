...
class FacetConceptMapping {

    final static Logger LOG = LoggerFactory.getLogger(FacetConceptMapping.class);

    @XmlElement(name = "facetConcept")
    List<FacetConcept> facetConcepts;


    Map<String, FacetConcept> getFacetConceptMap() {
        Map<String, FacetConcept> facetConceptMap = new HashMap<String, FacetConcept>();
        for (FacetConcept facet : facetConcepts) {
