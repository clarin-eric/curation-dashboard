	...
	<xsl:template match="/linkchecker-report">
		<html>
			...
			<table>
						...
						<tfoot>
							<tr>
							<td colspan="5">Total Count: <xsl:value-of select="overall/@count"></xsl:value-of> &#0183; Average Response Duration(ms): <xsl:value-of select="format-number(overall/@avgRespTime,'##.#')"></xsl:value-of></td>
							</tr>
						</tfoot>
