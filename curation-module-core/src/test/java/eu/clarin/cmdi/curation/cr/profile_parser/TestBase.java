...
public class TestBase {
    ...
    public static void initClass() {
        ...
        try {
            ...
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/waiting.html", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/audio_files/EMP1M1B1.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/audio_files/WBA1M3A2.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/text_files/WBA1M1A2a.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/audio_files/KUA2M1A1.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/text_files/KUA2M1.pdf", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/audio_files/sarixojani.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/audio_files/TEH11M7A1sa.mp3", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.ailla.org/text_files/TEH11M7.pdf", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://dspin.dwds.de:8088/ddc-sru/dta/", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://dspin.dwds.de:8088/ddc-sru/grenzboten/", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://dspin.dwds.de:8088/ddc-sru/rem/", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M084E-N1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M220P-N1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M119-N1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M171-G1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M185-N1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M048P-N1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("http://www.deutschestextarchiv.de/rem/?d=M112-G1.xml", today, "record", "NotGoogle", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("https://www.google.com", today, "GoogleRecord", "Google", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("https://maps.google.com", today, "GoogleRecord", "Google", null, today));
            Configuration.linkToBeCheckedResource.save(new LinkToBeChecked("https://drive.google.com", today, "GoogleRecord", "Google", null, today));
