...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/cmdProfileReport">
        ...
        <p>Number of facets covered by profile:
            <xsl:value-of select="./facetReport/@numOfFacetsCoveredByProfile"/>
        </p>
        ...
        <p>Total number of components:
            <xsl:value-of select="./componentReport/@total"/>
        </p>
        <p>Number of unique components:
            <xsl:value-of select="./componentReport/@unique"/>
        </p>
        ...
        <p>
            Score:
            <xsl:value-of select="format-number(./conceptReport/@score,'0.00')"/> /
            <xsl:value-of select="format-number(./conceptReport/@maxScore,'0.00')"/>
        </p>
        <p>
